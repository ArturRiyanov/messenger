...
export default function MessageItem({
    ...
    if (!message.sender) {
        return <div className="text-red-500 p-2">Ошибка: отправитель неизвестен</div>;
    }
            ...
            <div className={`max-w-xs rounded-lg p-3 ${
                ...
                {editing ? (
                    <div className="flex">
                        ...
                        />
                        <button onClick={handleEdit} className="ml-1">✓</button>
                        <button onClick={() => setEditing(false)} className="ml-1">✗</button>
                    </div>
                ) : (
